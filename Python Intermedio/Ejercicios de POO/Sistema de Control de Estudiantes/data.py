...
def parse_student_row(row, row_number):
    """Validate a CSV dictionary and return a Students object with numeric grades."""
    ...
    record = {"full_name": full_name, "section": section}
    ...
    # Dictionaries stay at the CSV boundary; the session stores student objects.
    return Students.from_dict(record)
