"""
Program: Phyton037.py - Store video game information in a CSV file (videogames.csv).
...
# Function that writes the list of records to the CSV file.
...
def write_records(records, filename=FILE_PATH):
    """Function that writes the list of video game records to a CSV file."""
    ...
    with open(filename, "a", encoding="utf-8", newline="") as file:
        writer = csv.DictWriter(file, fieldnames=FIELDS) # Create a CSV writer that uses the field names as keys.
...
def main():
    print()
    print("=== VIDEOJUEGOS - ARCHIVO videogames.csv ===")
